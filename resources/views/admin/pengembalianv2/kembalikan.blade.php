...
<div class="box">
    ...
    <div class="box-body">
        ...
        <form action="{{url('admin/pengembalianv2/simpan_pengembalian/'.$pinjam->id)}}" method="get">
            {{ csrf_field() }}
            ...
            <div class="form-group @error('nis_nip') has-error @enderror">
                ...
                <input type="text" name="nis_nip" class="form-control" placeholder="Masukkan NIS / NIP anggota" value="{{ $nis_nip }}" readonly>
                @error('nis_nip')
            ...
            <div class="form-group @error('denda') has-error @enderror">
                ...
                <input type="text" name="denda" class="form-control" placeholder="Masukkan NIS / NIP anggota" value="Rp {{ $denda }}" readonly>
                @error('denda')
                    <span class="help-block">{{ $message }}</span>
                @enderror
            </div>
